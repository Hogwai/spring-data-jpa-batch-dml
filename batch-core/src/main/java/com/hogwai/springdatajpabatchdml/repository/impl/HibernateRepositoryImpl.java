...
import com.hogwai.springdatajpabatchdml.repository.HibernateRepository;
...
/**
 * Base implementation of {@link HibernateRepository}.
 *
 * <p>Disables the default {@code save} methods (throws {@link UnsupportedOperationException})
 * and provides explicit {@code persist}, {@code merge} and {@code update} operations
 * with batch-aware variants that respect the configured JDBC batch size.</p>
 *
